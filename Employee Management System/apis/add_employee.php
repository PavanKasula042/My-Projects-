...
try {
    ...
    $statement = $pdo->prepare("Insert into employee_details (first_name,last_name,aadhar_number,phone_number,department_id,designation_id) values (?,?,?,?,?,?)");
    $queryResult = $statement->execute( [$_POST['firstName'],$_POST['lastName'],$_POST['Aadhaar'],$_POST['phoneNumber'],$_POST['designation'],$_POST['department'] ]);
    if($queryResult){
